...
Please note <tt>cell_name</tt> usage: it accepts a cell name. Currently
you should specify it manually, in the future it will be unnecessary
as long as correct cell class will be specified in <tt>describe</tt>
block. Then you should use <tt>render_cell</tt> method to perform cell
rendering.
